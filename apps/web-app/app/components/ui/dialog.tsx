...
const DialogPortal = ({
  ...
  <DialogPrimitive.Portal {...props}>
    <div
      className={`fixed inset-0 z-50 flex justify-center items-center ${children}`}
    >
      {children}
    </div>
...
const DialogOverlay = React.forwardRef<
  ...
  // unused variable: children - this component is the backdrop for alerts, does not need to render children
  ...
  (
    ...
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed z-50 grid w-full gap-4 rounded-lg bg-white p-6 sm:rounded-lg",
          "dark:bg-dark-mode-bg-400 dark:text-[#EFEFEF]",
          className
        )}
        {...props}
      >
